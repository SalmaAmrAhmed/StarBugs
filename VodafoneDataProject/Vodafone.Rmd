...
dailyTrainModel = sample_n(dailyTrainModel1, 1000)
...
daily <- train(TARGET~ ., data = dailyTrainModelTrained, method = "svmLinear2", trControl = trained)
summary(daily.rf)
predictions.randomforest <- predict(daily, dailyTestModel, "raw")




m <- table(predictions.randomforest, dailyTrainModelTestOriginal$TARGET )
